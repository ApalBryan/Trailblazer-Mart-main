                ...
                <div className="flex gap-2">
                  ...
                  {(order.status === "Pending Payment" || !order.status) && (
                    <>
                      ...
                      <button
                        ...
                        className="bg-gray-100 hover:bg-red-100 hover:text-red-600 text-gray-600 text-xs font-bold py-2 px-4 rounded transition"
                      >
                        Deny
                      </button>
                    </>
                  ...
                  {order.status === "Reserved" && (
                    <button
                      ...
                      className="bg-green-600 hover:bg-green-700 text-white text-xs font-bold py-2 px-4 rounded transition"
                    >
                      Mark as Claimed
                    </button>
                  )}
